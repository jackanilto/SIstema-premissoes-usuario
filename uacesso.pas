            ...
            facesso.close;
              ...
              vezes:=MessageBox(Handle, pchar('Erro de Login...Senha Incorreta !') , pchar('Acesso ao Sistema'), 21);
                 ...
                 if tenta = 2 then begin
                    messagebeep(16);
                    messagedlg('Acesso não permitido!',
...
procedure Tfacesso.Edit1KeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then // Define o comando enter
    btlogarClick(Sender); // Atribui a função do boatao entrar ao enter
end;
